entry = {"personality": ["i like to remodel homes .", "i like to go hunting .", "i like to shoot a bow .",
  ...
  "utterances": [
      {
          "candidates": [
              ...
              "hi there . how are you today ?", "i totally understand how stressful that can be .",
          ...
          "history": [
              "hi , how are you doing ? i'm getting ready to do some cheetah chasing to stay in "
              "shape ."]
      },
      {
          "candidates": [
              ...
              "."]},
      {
          "candidates": [
              ...
              "tell you , "
              "its against the "
              "rules but my name is "
              "sarah , call me o",
              "hello how are u "
              "tonight",
              "cool . . . my "
              "parents love country "
              "music that's why i "
              "hate it",
              "i am an accountant . "
              "what do you do ?",
